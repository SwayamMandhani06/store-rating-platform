    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full space-y-6 flex-1">
        ...
        <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/80 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 pl-10 pr-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 transition-colors"
              />
            </div>
            <div className="relative">
          ...
          <div className="flex items-center gap-2 pt-1 text-xs border-t border-slate-100 dark:border-slate-800 flex-wrap">
            ...
            {[
              ...
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium transition-all ${
                  sortBy === f.key
                    ? 'bg-brand-50 dark:bg-brand-950/60 text-brand-700 dark:text-brand-300 border border-brand-200/80 dark:border-brand-800/60'
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-12 text-center shadow-xs">
            <Inbox className="w-10 h-10 text-slate-300 dark:text-slate-600 mx-auto stroke-[1.5] mb-2" />
            <h3 className="font-heading font-semibold text-slate-800 dark:text-slate-200 text-base">No venues found</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {stores.map((store) => (
              <motion.div
                ...
                className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 rounded-2xl p-6 shadow-xs flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <h3 className="font-heading font-bold text-slate-900 dark:text-white text-lg leading-snug truncate">
                        {store.name}
                      </h3>
                  ...
                  <div className="mt-4 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 flex items-center justify-between">
                    <div>
                      ...
                      {store.overallRating ? (
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 mt-0.5 block">No ratings yet</span>
                      )}
                    </div>
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-brand-700 dark:text-brand-300 hover:bg-brand-50 dark:hover:bg-brand-950/60 transition-colors"
                ...
                <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                  ...
                  {savingId === store.id && (
                    <span className="text-xs text-brand-600 dark:text-brand-400 font-medium">Saving...</span>
                  )}
                </div>
              </motion.div>
            ))}
